...
%unique
k = 0
%counts the number of people in room required for atleast 0.5 probability
%initially number of people=0
prob = 0
while(prob<0.5)%to run until probability reaches atleast 0.5. counts number of people required.
